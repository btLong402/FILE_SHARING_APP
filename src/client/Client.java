      ...
      while (true) {
        ...
        switch (key) {
          case "CREATE_GROUP":
            if (isLogin == false) {
              System.out.println(
                "You do not have permission to create a group. Please log in."
              );
            } else {
          ...
          case "UPLOAD_FILE":
            if (isLogin == true) {
              ...
              System.out.println(
                "You do not have permission to upload a file. Please log in."
              );
            }
            break;
          case "DOWNLOAD_FILE":
            if (isLogin) {
              ...
              switch (response.get("responseCode").getAsInt()) {
                case 404:
                  System.out.println(
                    "Group or Folder or File does not exists!!!"
                  );
                  break;
                case 403:
                  System.out.println("You are not member of this group!");
              ...
              System.out.println(
                "You do not have permission to download a file. Please log in."
              );
            }
            break;
          case "LOGIN":
          ...
          case "LIST_ALL_GROUPS":
            if (isLogin == true) {
              ...
              System.out.println(
                "You do not have permission to see list groups. Please log in!"
              );
            }
            break;
          case "CREATE_FOLDER":
            if (isLogin == true) {
              ...
              System.out.println(
                "You do not have permission to create a folder. Please log in!"
              );
            }
            break;
          case "FOLDER_RENAME":
          ...
          case "FILE_RENAME":
            if (isLogin == true) {
              ...
              System.out.println(
                "You do not have permission to rename a file. Please log in!"
              );
            }
            break;
          case "FILE_COPY":
